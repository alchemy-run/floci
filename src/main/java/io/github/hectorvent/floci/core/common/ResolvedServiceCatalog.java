...
public class ResolvedServiceCatalog {
    ...
    public ResolvedServiceCatalog(EmulatorConfig config) {
        this.catalog = new ServiceCatalog(List.of(
                ...
                descriptor("dax", "dax", config.services().dax().enabled(), true,
                ...
                descriptor("kendra", "kendra", config.services().kendra().enabled(), true,
                ...
                descriptor("cassandra", "keyspaces", config.services().keyspaces().enabled(), true,
                        null, null, 5000L, null, ServiceProtocol.JSON,
                        protocols(ServiceProtocol.JSON),
                        Set.of("KeyspacesService."), Set.of("cassandra"), Set.of(), Set.of()),
                descriptor("keyspacesstreams", "keyspacesstreams", true, true,
                        null, null, 5000L, null, ServiceProtocol.JSON,
                        protocols(ServiceProtocol.JSON),
                        Set.of("KeyspacesStreams."), Set.of("cassandra"), Set.of(), Set.of()),
                ...
                descriptor("acm-pca", "acm-pca", config.services().acmPca().enabled(), true,
                        "acm-pca", config.storage().mode(), 5000L, null, ServiceProtocol.JSON,
                        protocols(ServiceProtocol.JSON),
                        Set.of("ACMPrivateCA."), Set.of("acm-pca"), Set.of(), Set.of()),
                ...
                descriptor("license-manager", "license-manager", config.services().licenseManager().enabled(), true,
                        ...
                        protocols(ServiceProtocol.JSON),
                        Set.of("AWSLicenseManager."), Set.of("license-manager"), Set.of(), Set.of()),
                ...
                descriptor("bedrock-agent", "bedrock-agent",
                        config.services().bedrockAgent().enabled(), true,
                        "bedrock-agent", storageMode(config.storage().services().bedrockAgent().mode(),
                                config.storage().mode()),
                        config.storage().services().bedrockAgent().flushIntervalMs(), null,
                        ServiceProtocol.REST_JSON,
                        protocols(ServiceProtocol.REST_JSON),
                        Set.of(), Set.of("bedrock-agent"), Set.of(),
                        Set.of(BedrockAgentController.class)),
                descriptor("bedrock-agentcore", "bedrock-agent-core",
                        config.services().bedrockAgentCore().enabled(), true,
                        "bedrockagentcore", storageMode(config.storage().services().bedrockAgentCore().mode(),
                                config.storage().mode()),
                        config.storage().services().bedrockAgentCore().flushIntervalMs(), null,
                        ServiceProtocol.REST_JSON,
                        protocols(ServiceProtocol.REST_JSON),
                ...
                descriptor("mwaaserverless", "mwaaserverless", config.services().mwaaServerless().enabled(), true,
                        null, null, 5000L, null, ServiceProtocol.JSON,
                        protocols(ServiceProtocol.JSON),
                        Set.of("AmazonMWAAServerless."),
                        Set.of("airflow-serverless", "mwaaserverless"), Set.of(), Set.of()),
                ...
                descriptor("codeconnections", "codeconnections", config.services().codeconnections().enabled(), true,
                        "codeconnections",
                        storageMode(config.storage().services().codeconnections().mode(), config.storage().mode()),
                        config.storage().services().codeconnections().flushIntervalMs(), null, ServiceProtocol.JSON,
                        protocols(ServiceProtocol.JSON),
                        Set.of("CodeConnections_20231201."), Set.of("codeconnections"), Set.of(), Set.of()),
                ...
                descriptor("backup-search", "backupsearch", config.services().backupsearch().enabled(), true,
                        "backupsearch", storageMode(config.storage().services().backupsearch().mode(),
                                config.storage().mode()),
                ...
                descriptor("datazone", "datazone", config.services().datazone().enabled(), true,
                        "datazone", storageMode(config.storage().services().datazone().mode(),
                                config.storage().mode()),
                        config.storage().services().datazone().flushIntervalMs(), null, ServiceProtocol.REST_JSON,
                        protocols(ServiceProtocol.REST_JSON),
                        Set.of(), Set.of("datazone"), Set.of(), Set.of(DataZoneController.class)),
                ...
                descriptor("healthlake", "healthlake", config.services().healthlake().enabled(), true,
                        null, null, 5000L, null, ServiceProtocol.JSON,
                        protocols(ServiceProtocol.JSON),
                ...
                descriptor("iotfleetwise", "iotfleetwise", config.services().iotfleetwise().enabled(), true,
                        "iotfleetwise", config.storage().mode(), 5000L, null, ServiceProtocol.JSON,
                ...
                descriptor("application-signals", "applicationsignals",
                        ...
                        "applicationsignals", storageMode(config.storage().services().applicationSignals().mode(),
                                config.storage().mode()),
                        config.storage().services().applicationSignals().flushIntervalMs(), null,
                        ServiceProtocol.REST_JSON,
                        protocols(ServiceProtocol.REST_JSON),
