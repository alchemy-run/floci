...
import io.github.hectorvent.floci.services.sagemaker.SageMakerFeatureStoreRuntimeController;
    ...
    public ResolvedServiceCatalog(EmulatorConfig config) {
        this.catalog = new ServiceCatalog(List.of(
                ...
                descriptor("lambda", "lambda", config.services().lambda().enabled(), true,
                        ...
                        Set.of(LambdaController.class, LambdaDurableController.class,
                                MicrovmController.class, MicrovmEndpointProxyController.class,
                                LambdaMicrovmsController.class, LambdaNetworkConnectorsController.class)),
                ...
                descriptor("sagemaker", "sagemaker", config.services().sagemaker().enabled(), true,
                        ...
                        Set.of(SageMakerRuntimeController.class, SageMakerFeatureStoreRuntimeController.class)),
