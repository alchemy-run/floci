...
/**
 * Amazon Inspector2 restJson1 shares short paths ({@code /members},
 * {@code /findings}, {@code /coverage}, {@code /encryptionkey}) with other
 * services and S3's {@code /{bucket}} catch-all. SigV4 credential scope
 * {@code inspector2} is rewritten onto an internal prefix the Inspector2
 * controller owns. Tag APIs stay on {@code /tags/{arn}}.
 */
@Provider
@PreMatching
@Priority(10)
public class Inspector2RoutingFilter implements ContainerRequestFilter {

    static final String INTERNAL_PREFIX = "/inspector2";
    static final String SERVICE = "inspector2";
    ...
    public void filter(ContainerRequestContext requestContext) {
        if (!isInspector2(requestContext.getHeaderString("Authorization"))) {
            return;
        }
    ...
    static boolean isInspector2(String authorization) {
