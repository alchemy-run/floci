...
public interface KmsKeyType {
    ...
    default byte[] deriveSharedSecret(KmsKey key, byte[] publicKeyDer) throws Exception {
        throw new IllegalStateException(key.getKeySpec() + " does not support key agreement");
    }
