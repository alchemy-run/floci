...
/**
 * S3 Tables restJson1 paths such as {@code /buckets} and {@code /tables/{arn}} collide
...
@PreMatching
@Priority(10)
public class S3TablesRoutingFilter implements ContainerRequestFilter {

    static final String INTERNAL_PREFIX = "/aws-s3tables";
    ...
    static boolean isS3Tables(String authorization) {
