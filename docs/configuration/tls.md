...
- Includes `localhost`, `127.0.0.1`, `0.0.0.0`, `*.localhost`, `localhost.floci.io`, `*.localhost.floci.io`, `host.docker.internal`, `sync-states.us-east-1.amazonaws.com`, `sync-states-fips.us-east-1.amazonaws.com`, and `*.us-east-1.amazonaws.com` as Subject Alternative Names (SANs)
