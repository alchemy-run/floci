...
- **`FilterLogEvents`** and subscription delivery match plain substrings, quoted phrases,
  and `?` optional terms. The full filter pattern syntax described below is applied by metric filters.
